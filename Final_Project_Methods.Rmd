...
```
The residual for the Cholesterol is very normal, the ends curve slightly but overall they look pretty good. The residuals for the Insulin however look very logamarthic in shape. We can consider making the appropriate log transformation in order to match our SLR assumptions. 
...
data.frame(residuals = Insulin_lm$residuals,
  ...
  labs(x = "Fitted", y = "Residuals")
```
Our residuals look pretty good, there may be a small amount of fanning that we would put in our limitations, however over all both look sufficient. 
