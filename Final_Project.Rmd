...
### Female
```{r}
Insulin_female_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Sex == "female")
summary(Insulin_female_lm)
```

### Male 
```{r}
Insulin_male_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Sex == "male")
...
### Working
```{r}
Insulin_work_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Age_Group == "working")
summary(Insulin_work_lm)
```
### Retired
```{r}
Insulin_retired_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Age_Group == "retired")
...
### Yes
```{r}
Insulin_retired_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Diabetes == "yes")
summary(Insulin_retired_lm)
```

```{r}
Insulin_retired_lm <- lm(Insulin ~ Hrs_Food, data = Data_df, Diabetes == "other")
summary(Insulin_retired_lm)
```
